  ...
  return (
    <div>
      <form className="max-w-sm mx-auto">
        ...
        <button type="submit" className="text-white bg-brand box-border border border-default-medium hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">Submit</button>
      </form>
    </div>
  )
}
