    ...
    <>
      <div className="flex h-full min-h-0 flex-col items-center justify-center gap-4 overflow-hidden p-4" >
        <div className="flex w-full shrink-0 flex-col items-center border-2 border-solid p-4">
          <h1 className="text-lg font-semibold pb-5">How are you feeling today?</h1>
        ...
        <div className="w-full max-w-[591px] flex-1 min-h-0 overflow-hidden border-2 border-solid p-4 flex flex-col items-center">
          <div className="flex justify-center w-full mb-5 shrink-0">
          ...
          <div className="mt-3 flex items-center justify-between text-xs text-gray-500 w-full shrink-0">
            <span>{content.length} chars</span>
            <Button className="h-7" onClick={handleSubmit}>
              Save
            </Button>
          </div>
        </div>
